...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/diploma_modules_cart_handler_model.MessageResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/diploma_modules_cart_handler_model.CheckoutRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/diploma_modules_product_handler_model.AdminProductInput"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.ProductMessageResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.FavoriteListResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/api/product/featured": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Limit number of featured products",
                        "name": "limit",
                        "in": "query"
                    }
                ],
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.ProductSuggestionResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.FavoriteStatusResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/diploma_modules_product_handler_model.ReviewInput"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "diploma_modules_cart_handler_model.CheckoutRequest": {
            "type": "object",
            "required": [
                "address_id"
            ],
        ...
        "diploma_modules_cart_handler_model.MessageResponse": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string"
        ...
        "diploma_modules_product_handler_model.AdminProductInput": {
            "type": "object",
            "required": [
                "name"
            ],
        ...
        "diploma_modules_product_handler_model.DetailedProduct": {
            ...
            "properties": {
                ...
                "reviews": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/diploma_modules_product_handler_model.Review"
                    }
                },
                "suppliers": {
                    "type": "array",
        ...
        "diploma_modules_product_handler_model.Review": {
            "type": "object",
            "properties": {
                "comment": {
                    "type": "string"
        ...
        "diploma_modules_product_handler_model.ReviewInput": {
            "type": "object",
            "required": [
                "rating"
            ],
        ...
        "handler.ListResponse": {
            ...
            "properties": {
                "notifications": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handler.Notification"
                    }
                }
            }
        },
        ...
        "model.ProductSuggestionResponse": {
            "type": "object",
            "properties": {
                "suggestions": {
                    "type": "array",
